...
//sender2.send(m0)
		...
		.setFooter(`${msg.guild.name}`)
		let sender8v2 = msg.guild.channels.get("730373389570670664")
		sender8v2.send(m8v2)
		//
		...
		let sender9 = msg.guild.channels.get('738740315929968771')
		sender9.send(m9)
		...
		.setFooter(`${msg.guild.name}`)
		let sender9v2 = msg.guild.channels.get("738741075279216642")
		sender9v2.send(m9v2)
